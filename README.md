===================================================
Everything about this repo remains the same, just providing a custom script which allows AI Goat to be used in a lab environment along with other vuln containers. The script also spins up a kasm/kali box, but you can use your own kali VM or machine to interact with the lab. 
